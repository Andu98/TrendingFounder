...
Always use the following superpowers skills when applicable:
...
- **finishing-a-development-branch**: When implementation is complete, all tests pass, and you need to decide how to integrate the work
- **executing-plans**: When executing comprehensive plans, particularly in parallel
- **subagent-driven-development**: When executing a set of subtasks driven by subagents
- **writing-skills**: For writing new skill files or updating existing ones
- **using-superpowers**: The overarching skill that ensures correct skill invocation
